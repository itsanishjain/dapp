...
export default function Card({ name, designation, imageUrl }) {
  return (
    <>
      ...
      <div className="max-w-sm mx-auto mt-8 space-y-2 p-8 bg-blue-200 rounded-lg shadow-md shadow-slate-300 sm:flex items-center sm:py-4 sm:space-x-6">
        <img
          src={imageUrl}
          className=" mx-auto w-24 h-24 rounded-full sm:mx-0 sm:shrink-0"
          alt="logo"
        />
